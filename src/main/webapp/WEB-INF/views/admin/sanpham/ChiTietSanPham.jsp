...
<body>
	...
	<div class="container-fluid wrapper">
		...
		<div class="general_info">
			...
			<div>
				<b>Loại sản phẩm: </b> ${ sanPham.tenLoaiSanPham }
			</div>
			<div>
				<b>Thương hiệu: </b> ${ sanPham.tenThuongHieu }
			</div>
			<div>
				<b>Dòng sản phẩm: </b> ${ sanPham.tenDongSanPham }
			</div>
			<div class="flex_mau">
	...
	<script type="text/javascript">
		function xoaMauSanPham(maSanPham, maMau){
			const url = "http://localhost:8081/websiteVali/api/san-pham/xoa-mau-san-pham?maSanPham=" + maSanPham + "&maMau=" + maMau;
			...
			$.ajax({
				...
				success: function (result) {
					if(result == 1){
						...
						window.location.href = "http://localhost:8081/websiteVali/admin/san-pham/xem-chi-tiet?id=" + maSanPham;
