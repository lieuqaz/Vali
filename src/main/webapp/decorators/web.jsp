...
<body>
					...
					<sec:authorize access="isAuthenticated()">
						...
						<div class="nav-item dropdown no-arrow">
							<a class="nav-link dropdown-toggle cart__link" href="#"
								...
								src="<c:url value='/static/assets/img/avatar.png'/>"
				...
				<div class="footer">
					...
					<div class="infomation">
						...
						<hr>
							...
							<p>Email: lieu@gmail.com</p>
							<p>Số điện thoại: 0337479600</p>
							<p>Địa chỉ: Đà Nẵng</p>
	...
	<script type="text/javascript">
		function searchType() {
			...
			window.location.href = "http://localhost:8081/WebsiteVali/danh-sach-san-pham/tim-kiem-san-pham?tenSanPham="
					+ textSearch + "&page=1";
		}
	</script>
</body>
