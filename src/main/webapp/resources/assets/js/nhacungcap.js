...
function xoa(id) {
	...
	if (cf == true) {
		$.ajax({
			url: "http://localhost:8081/websiteVali/api/nha-cung-cap/xoa?id=" + id ,
			type: 'DELETE',
			success: function (result) {
				if(result == 1){
					window.location.href = 'http://localhost:8081/websiteVali/admin/nha-cung-cap/danh-sach-nha-cung-cap';
