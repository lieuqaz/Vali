...
public class SanPhamDTO {
	...
	public SanPhamDTO(String id, String tenSanPham, String moTa, double giaNhap, double giaBan, String xuatXu,
			boolean trangThai, int baoHanh, int namSanXuat, String maDongSanPham, String tenDongSanPham,
			String maLoaiSanPham, String tenLoaiSanPham, String maThuongHieu, String tenThuongHieu,
			String hinhAnhBase64, int tongSoLuong) {
		super();
		this.id = id;
		this.tenSanPham = tenSanPham;
		this.moTa = moTa;
	...
	public SanPhamDTO(String id, String tenSanPham, String moTa, double giaNhap, double giaBan, String xuatXu,
			boolean trangThai, int baoHanh, int namSanXuat, String maDongSanPham, String tenDongSanPham,
			String maLoaiSanPham, String tenLoaiSanPham, String maThuongHieu, String tenThuongHieu,
			String hinhAnhBase64, List<MauSanPhamDTO> listMauSanPhamDTOs) {
		super();
		this.id = id;
		this.tenSanPham = tenSanPham;
		this.moTa = moTa;
	...
	public String toString() {
		return "SanPhamDTO [id=" + id + ", tenSanPham=" + tenSanPham + ", moTa=" + moTa + ", giaNhap=" + giaNhap
				...
				+ ", namSanXuat=" + namSanXuat + ", maDongSanPham=" + maDongSanPham + ", tenDongSanPham="
				+ tenDongSanPham + ", maLoaiSanPham=" + maLoaiSanPham + ", tenLoaiSanPham=" + tenLoaiSanPham
				+ ", maThuongHieu=" + maThuongHieu + ", tenThuongHieu=" + tenThuongHieu + ", hinhAnhBase64="
				+ hinhAnhBase64 + ", listMauSanPhamDTOs=" + listMauSanPhamDTOs + ", tongSoLuong=" + tongSoLuong + "]";
	}
