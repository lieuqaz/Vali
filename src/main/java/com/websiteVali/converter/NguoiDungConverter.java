...
//			Xóa các kí tự "," dư ở đầu chuỗi
		...
		NguoiDung nguoiDung = new NguoiDung(id, fullName, phone, email, password, role, true);
...
//			Xóa các kí tự "," dư ở đầu chuỗi
		...
		NguoiDung user = new NguoiDung(id, fullName, phone, email, password, role, enabled);
